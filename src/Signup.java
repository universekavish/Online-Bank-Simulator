...
public class Signup extends JFrame implements ActionListener{
	...
	Signup(){
        ...
        t1 = new JTextField();
        t1.setFont(new Font("Ralewway", Font.BOLD,14));
        ...
        String year[] = {"1999","2000","2001","2002","2003","2004","2005","2006","2007","2008"};
	...
	public void actionPerformed(ActionEvent ae) {
        ...
        try{
            ...
            if(t6.getText().equals("")){
                ...
                conn c1 = new conn();
                String q1 = "insert into signup values('"+formno+"','"+a+"','"+b+"','"+ac+"','"+bc+"','"+cc+"','"+gender+"','"+email+"','"+marital+"','"+address+"','"+city+"','"+pincode+"','"+state+"')";
